...
class ScenarioSweep:
    ...
    def redistribute_slack(self):
        ...
        unit leaving the pool (and that row's distributed slack), the powerflow then only
        sharing what is left (the change in the losses) on the units that can still move.
