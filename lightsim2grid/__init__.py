...
try:
    ...
    pass
    print(f"LightSimBackend import error: {exc}")
...
try:
    ...
    pass
    print(f"PhysicalLawChecker import error: {exc}")
...
try:
    ...
    pass
    print(f"TimeSerie import error: {exc}")
...
try:
    ...
    pass
    print(f"SecurityAnalysis import error: {exc}")
