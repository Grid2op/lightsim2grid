...
ErrorType NICSLULinearSolver::analyze(const Eigen::Ref<const Eigen::SparseMatrix<real_type>> & J){
...
ErrorType NICSLULinearSolver::factorize(const Eigen::Ref<const Eigen::SparseMatrix<real_type>> & J){
...
ErrorType NICSLULinearSolver::refactorize(const Eigen::Ref<const Eigen::SparseMatrix<real_type>> & J){
