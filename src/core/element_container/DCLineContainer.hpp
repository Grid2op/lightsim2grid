...
class LS2G_API DCLineContainer final : public TwoSidesContainer<GeneratorContainer>, public IteratorAdder<DCLineContainer, DCLineInfo>
{
    ...
    public:
        ...
        DCLineContainer() noexcept {
            DualAlgoControl solver_control_not_used;
        ...
        void change_p(int dcline_id, real_type new_p, DualAlgoControl & sovler_control){
        ...
        void change_v_side_1(int dcline_id, real_type new_v_pu, DualAlgoControl & sovler_control){
            side_1_.change_v(dcline_id, new_v_pu, sovler_control);
        }
        void change_v_side_2(int dcline_id, real_type new_v_pu, DualAlgoControl & sovler_control){
