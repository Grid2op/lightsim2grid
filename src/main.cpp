...
PYBIND11_MODULE(lightsim2grid_cpp, m)
{
    ...
    py::class_<TrafoInfo>(m, "TrafoInfo", DocIterator::TrafoInfo.c_str())
        ...
        .def_readonly("is_tap_hv_side", &TrafoInfo::is_tap_hv_side, DocIterator::is_tap_hv_side.c_str())
...
between 0 and `n_sub_ * max_nb_bus_per_sub_`
        ...
        .def("get_all_shunt_buses", &GridModel::get_all_shunt_buses_numpy, DocGridModel::_internal_do_not_use.c_str())
