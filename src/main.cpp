...
PYBIND11_MODULE(lightsim2grid_cpp, m)
{
    ...
    py::class_<DataLine::LineInfo>(m, "LineInfo")
        ...
        .def_readonly("r", &DataLine::LineInfo::r)
        .def_readonly("x", &DataLine::LineInfo::x)
        .def_readonly("h", &DataLine::LineInfo::h)
        ...
        .def_readonly("res_a_or_a", &DataLine::LineInfo::res_a_or_a)
        ...
        .def_readonly("res_a_ex_a", &DataLine::LineInfo::res_a_ex_a)
