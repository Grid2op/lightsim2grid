...
PYBIND11_MODULE(lightsim2grid_cpp, m)
{
    ...
    py::class_<GeneratorContainer::GenInfo>(m, "GenInfo", DocIterator::GenInfo.c_str())
        ...
        .def_readonly("sub_id", &GeneratorContainer::GenInfo::sub_id, DocIterator::sub_id.c_str())
        .def_readonly("pos_topo_vect", &GeneratorContainer::GenInfo::pos_topo_vect, DocIterator::pos_topo_vect.c_str())
    ...
    py::class_<SGenContainer::SGenInfo>(m, "SGenInfo", DocIterator::SGenInfo.c_str())
        ...
        .def_readonly("sub_id", &SGenContainer::SGenInfo::sub_id, DocIterator::sub_id.c_str())
        .def_readonly("pos_topo_vect", &SGenContainer::SGenInfo::pos_topo_vect, DocIterator::pos_topo_vect.c_str())
    ...
    py::class_<LoadContainer::LoadInfo>(m, "LoadInfo", DocIterator::LoadInfo.c_str())
        ...
        .def_readonly("sub_id", &LoadContainer::LoadInfo::sub_id, DocIterator::sub_id.c_str())
        .def_readonly("pos_topo_vect", &LoadContainer::LoadInfo::pos_topo_vect, DocIterator::pos_topo_vect.c_str())
    ...
    py::class_<ShuntContainer::ShuntInfo>(m, "ShuntInfo", DocIterator::ShuntInfo.c_str())
        ...
        .def_readonly("sub_id", &ShuntContainer::ShuntInfo::sub_id, DocIterator::sub_id.c_str())
        .def_readonly("pos_topo_vect", &ShuntContainer::ShuntInfo::pos_topo_vect, DocIterator::pos_topo_vect.c_str())
    ...
    py::class_<TrafoContainer::TrafoInfo>(m, "TrafoInfo", DocIterator::TrafoInfo.c_str())
        ...
        .def_readonly("sub_1_id", &TrafoContainer::TrafoInfo::sub_1_id, DocIterator::sub_id.c_str())
        .def_readonly("sub_2_id", &TrafoContainer::TrafoInfo::sub_2_id, DocIterator::sub_id.c_str())
        .def_readonly("pos_1_topo_vect", &TrafoContainer::TrafoInfo::pos_1_topo_vect, DocIterator::pos_topo_vect.c_str())
        .def_readonly("pos_2_topo_vect", &TrafoContainer::TrafoInfo::pos_2_topo_vect, DocIterator::pos_topo_vect.c_str())

        .def_readonly("connected_global", &TrafoContainer::TrafoInfo::connected_global, DocIterator::connected.c_str())
        .def_readonly("connected_1", &TrafoContainer::TrafoInfo::connected_1, DocIterator::connected.c_str())
        .def_readonly("connected_2", &TrafoContainer::TrafoInfo::connected_2, DocIterator::connected.c_str())

        .def_readonly("bus_1_id", &TrafoContainer::TrafoInfo::bus_1_id, DocIterator::bus_hv_id.c_str())
        .def_readonly("bus_2_id", &TrafoContainer::TrafoInfo::bus_2_id, DocIterator::bus_lv_id.c_str())
        ...
        .def_readonly("res_p1_mw", &TrafoContainer::TrafoInfo::res_p1_mw, DocIterator::res_p_hv_mw.c_str())
        .def_readonly("res_q1_mvar", &TrafoContainer::TrafoInfo::res_q1_mvar, DocIterator::res_q_hv_mvar.c_str())
        .def_readonly("res_v1_kv", &TrafoContainer::TrafoInfo::res_v1_kv, DocIterator::res_v_hv_kv.c_str())
        .def_readonly("res_a1_ka", &TrafoContainer::TrafoInfo::res_a1_ka, DocIterator::res_a_hv_ka.c_str())
        .def_readonly("res_p2_mw", &TrafoContainer::TrafoInfo::res_p2_mw, DocIterator::res_p_lv_mw.c_str())
        .def_readonly("res_q2_mvar", &TrafoContainer::TrafoInfo::res_q2_mvar, DocIterator::res_q_lv_mvar.c_str())
        .def_readonly("res_v2_kv", &TrafoContainer::TrafoInfo::res_v2_kv, DocIterator::res_v_lv_kv.c_str())
    ...
    py::class_<DCLineContainer::DCLineInfo>(m, "DCLineInfo", DocIterator::DCLineInfo.c_str())
        ...
        .def_readonly("sub_1_id", &DCLineContainer::DCLineInfo::sub_1_id, DocIterator::sub_id.c_str())
        .def_readonly("sub_2_id", &DCLineContainer::DCLineInfo::sub_2_id, DocIterator::sub_id.c_str())
        .def_readonly("pos_1_topo_vect", &DCLineContainer::DCLineInfo::pos_1_topo_vect, DocIterator::pos_topo_vect.c_str())
        .def_readonly("pos_2_topo_vect", &DCLineContainer::DCLineInfo::pos_2_topo_vect, DocIterator::pos_topo_vect.c_str())
        .def_readonly("connected_global", &DCLineContainer::DCLineInfo::connected_global, DocIterator::connected.c_str())
        .def_readonly("connected_1", &DCLineContainer::DCLineInfo::connected_1, DocIterator::connected.c_str())
        ...
        .def_readonly("gen_side_2", &DCLineContainer::DCLineInfo::gen_side_2, DocIterator::gen_ex.c_str())
        .def_readonly("has_res", &DCLineContainer::DCLineInfo::has_res, DocIterator::has_res.c_str())
        .def_readonly("res_p1_mw", &DCLineContainer::DCLineInfo::res_p1_mw, DocIterator::res_p_or_mw_dcline.c_str())
        .def_readonly("res_p2_mw", &DCLineContainer::DCLineInfo::res_p2_mw, DocIterator::res_p_ex_mw_dcline.c_str())
        .def_readonly("res_q1_mvar", &DCLineContainer::DCLineInfo::res_q1_mvar, DocIterator::res_q_or_mvar_dcline.c_str())
        .def_readonly("res_q2_mvar", &DCLineContainer::DCLineInfo::res_q2_mvar, DocIterator::res_q_ex_mvar_dcline.c_str())
        .def_readonly("res_v1_kv", &DCLineContainer::DCLineInfo::res_v1_kv, DocIterator::res_v_or_kv_dcline.c_str())
        .def_readonly("res_v2_kv", &DCLineContainer::DCLineInfo::res_v2_kv, DocIterator::res_v_ex_kv_dcline.c_str())
        .def_readonly("res_theta1_deg", &DCLineContainer::DCLineInfo::res_theta1_deg, DocIterator::res_theta_or_deg_dcline.c_str())
