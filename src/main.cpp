...
PYBIND11_MODULE(lightsim2grid_cpp, m)
{
    ...
    py::class_<TrafoContainer::TrafoInfo>(m, "TrafoInfo", DocIterator::TrafoInfo.c_str())
        ...
        .def_readonly("res_p1_mw", &TrafoContainer::TrafoInfo::res_p1_mw, DocIterator::res_p_lv_mw.c_str())
        .def_readonly("res_q1_mvar", &TrafoContainer::TrafoInfo::res_q1_mvar, DocIterator::res_q_lv_mvar.c_str())
