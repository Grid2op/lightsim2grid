...
void bind_enums(py::module_& m) {
    ...
    py::enum_<AlgorithmType>(m, "AlgorithmType", "This enum controls the powerflow algorithm you want to use.")
        ...
        .value("GaussSeidelSynch", AlgorithmType::GaussSeidelSynch, "denotes the :class:`lightsim2grid.algorithm.GaussSeidelSynchAlgo`")
        // ---- SparseLU family ----
        .value("NR_SparseLU",     AlgorithmType::NR_SparseLU,     "Newton-Raphson (multi-slack) + SparseLU; see :class:`lightsim2grid.algorithm.NR_SparseLU`")
        .value("NRSing_SparseLU", AlgorithmType::NRSing_SparseLU, "Newton-Raphson (single-slack) + SparseLU; see :class:`lightsim2grid.algorithm.NRSing_SparseLU`")
        .value("DC_SparseLU",     AlgorithmType::DC_SparseLU,     "DC approximation + SparseLU; see :class:`lightsim2grid.algorithm.DC_SparseLU`")
        .value("FDPF_XB_SparseLU", AlgorithmType::FDPF_XB_SparseLU, "Fast-Decoupled PF (XB) + SparseLU; see :class:`lightsim2grid.algorithm.FDPF_XB_SparseLU`")
        .value("FDPF_BX_SparseLU", AlgorithmType::FDPF_BX_SparseLU, "Fast-Decoupled PF (BX) + SparseLU; see :class:`lightsim2grid.algorithm.FDPF_BX_SparseLU`")
        // ---- KLU family ----
        .value("NR_KLU",          AlgorithmType::NR_KLU,     "Newton-Raphson (multi-slack) + KLU; see :class:`lightsim2grid.algorithm.NR_KLU`")
        .value("NRSing_KLU",      AlgorithmType::NRSing_KLU, "Newton-Raphson (single-slack) + KLU; see :class:`lightsim2grid.algorithm.NRSing_KLU`")
        .value("DC_KLU",          AlgorithmType::DC_KLU,     "DC approximation + KLU; see :class:`lightsim2grid.algorithm.DC_KLU`")
        .value("FDPF_XB_KLU",     AlgorithmType::FDPF_XB_KLU, "Fast-Decoupled PF (XB) + KLU; see :class:`lightsim2grid.algorithm.FDPF_XB_KLU`")
        .value("FDPF_BX_KLU",     AlgorithmType::FDPF_BX_KLU, "Fast-Decoupled PF (BX) + KLU; see :class:`lightsim2grid.algorithm.FDPF_BX_KLU`")
        // ---- NICSLU family ----
        .value("NR_NICSLU",       AlgorithmType::NR_NICSLU,     "Newton-Raphson (multi-slack) + NICSLU; see :class:`lightsim2grid.algorithm.NR_NICSLU`")
        .value("NRSing_NICSLU",   AlgorithmType::NRSing_NICSLU, "Newton-Raphson (single-slack) + NICSLU; see :class:`lightsim2grid.algorithm.NRSing_NICSLU`")
        .value("DC_NICSLU",       AlgorithmType::DC_NICSLU,     "DC approximation + NICSLU; see :class:`lightsim2grid.algorithm.DC_NICSLU`")
        .value("FDPF_XB_NICSLU",  AlgorithmType::FDPF_XB_NICSLU, "Fast-Decoupled PF (XB) + NICSLU; see :class:`lightsim2grid.algorithm.FDPF_XB_NICSLU`")
        .value("FDPF_BX_NICSLU",  AlgorithmType::FDPF_BX_NICSLU, "Fast-Decoupled PF (BX) + NICSLU; see :class:`lightsim2grid.algorithm.FDPF_BX_NICSLU`")
        // ---- CKTSO family ----
        .value("NR_CKTSO",        AlgorithmType::NR_CKTSO,     "Newton-Raphson (multi-slack) + CKTSO; see :class:`lightsim2grid.algorithm.NR_CKTSO`")
        .value("NRSing_CKTSO",    AlgorithmType::NRSing_CKTSO, "Newton-Raphson (single-slack) + CKTSO; see :class:`lightsim2grid.algorithm.NRSing_CKTSO`")
        .value("DC_CKTSO",        AlgorithmType::DC_CKTSO,     "DC approximation + CKTSO; see :class:`lightsim2grid.algorithm.DC_CKTSO`")
        .value("FDPF_XB_CKTSO",   AlgorithmType::FDPF_XB_CKTSO, "Fast-Decoupled PF (XB) + CKTSO; see :class:`lightsim2grid.algorithm.FDPF_XB_CKTSO`")
        .value("FDPF_BX_CKTSO",   AlgorithmType::FDPF_BX_CKTSO, "Fast-Decoupled PF (BX) + CKTSO; see :class:`lightsim2grid.algorithm.FDPF_BX_CKTSO`")
        // ---- Plugin/external ----
