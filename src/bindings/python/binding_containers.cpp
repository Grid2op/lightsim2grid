...
void bind_containers(py::module_& m) {
    ...
    py::class_<GenInfo>(m, "GenInfo", DocIterator::GenInfo.c_str())
        ...
        .def_readonly("target_p_mw", &GenInfo::target_p_mw, DocIterator::gen_target_p_mw.c_str())
        .def_readonly("target_vm_pu", &GenInfo::target_vm_pu, DocIterator::gen_target_vm_pu.c_str())
        ...
        .def_readonly("voltage_level_id", &GenInfo::sub_id, DocIterator::gen_sub_id.c_str());
    ...
    py::class_<SvcInfo>(m, "SvcInfo", DocIterator::SvcInfo.c_str())
        ...
        .def_readonly("voltage_level_id", &SvcInfo::sub_id, DocIterator::svc_sub_id.c_str());
    ...
    py::class_<SGenInfo>(m, "SGenInfo", DocIterator::SGenInfo.c_str())
        ...
        .def_readonly("target_p_mw", &SGenInfo::target_p_mw, DocIterator::sgen_target_p_mw.c_str())
        .def_readonly("target_q_mvar", &SGenInfo::target_q_mvar, DocIterator::sgen_target_q_mvar.c_str())
        ...
        .def_readonly("voltage_level_id", &SGenInfo::sub_id, DocIterator::sgen_sub_id.c_str());
    ...
    py::class_<LoadInfo>(m, "LoadInfo", DocIterator::LoadInfo.c_str())
        ...
        .def_readonly("target_p_mw", &LoadInfo::target_p_mw, DocIterator::load_target_p_mw.c_str())
        .def_readonly("target_q_mvar", &LoadInfo::target_q_mvar, DocIterator::load_target_q_mvar.c_str())
        ...
        .def_readonly("voltage_level_id", &LoadInfo::sub_id, DocIterator::load_sub_id.c_str());
    ...
    py::class_<StorageInfo>(m, "StorageInfo", DocIterator::LoadInfo.c_str())
        ...
        .def_readonly("target_p_mw", &StorageInfo::target_p_mw, DocIterator::storage_target_p_mw.c_str())
        .def_readonly("target_q_mvar", &StorageInfo::target_q_mvar, DocIterator::storage_target_q_mvar.c_str())
        .def_readonly("voltage_regulator_on", &StorageInfo::voltage_regulator_on, DocIterator::storage_voltage_regulator_on.c_str())
        ...
        .def_readonly("voltage_level_id", &StorageInfo::sub_id, DocIterator::storage_sub_id.c_str());
    ...
    py::class_<ShuntInfo>(m, "ShuntInfo", DocIterator::ShuntInfo.c_str())
        ...
        .def_readonly("target_p_mw", &ShuntInfo::target_p_mw, DocIterator::shunt_target_p_mw.c_str())
        .def_readonly("target_q_mvar", &ShuntInfo::target_q_mvar, DocIterator::shunt_target_q_mvar.c_str())
    ...
    py::class_<TrafoInfo>(m, "TrafoInfo", DocIterator::TrafoInfo.c_str())
        ...
        .def_readonly("connected1", &TrafoInfo::connected_1, DocIterator::trafo_connected1.c_str())
        .def_readonly("connected2", &TrafoInfo::connected_2, DocIterator::trafo_connected2.c_str())
        ...
        .def_readonly("voltage_level1_id", &TrafoInfo::sub_1_id, DocIterator::trafo_sub1_id.c_str())
        .def_readonly("voltage_level2_id", &TrafoInfo::sub_2_id, DocIterator::trafo_sub2_id.c_str());
    ...
    py::class_<LineInfo>(m, "LineInfo", DocIterator::LineInfo.c_str())
        ...
        .def_readonly("connected1", &LineInfo::connected_1, DocIterator::line_connected1.c_str())
        .def_readonly("connected2", &LineInfo::connected_2, DocIterator::line_connected2.c_str())
        .def_readonly("bus1_id", &LineInfo::bus_1_id, DocIterator::line_bus1_id.c_str())
        .def_readonly("bus2_id", &LineInfo::bus_2_id, DocIterator::line_bus2_id.c_str())
        ...
        .def_readonly("voltage_level1_id", &LineInfo::sub_1_id, DocIterator::line_sub1_id.c_str())
        .def_readonly("voltage_level2_id", &LineInfo::sub_2_id, DocIterator::line_sub2_id.c_str());
    ...
    py::class_<HvdcLineInfo>(m, "HvdcLineInfo", DocIterator::DCLineInfo.c_str())
        ...
        .def_readonly("connected1", &HvdcLineInfo::connected_1, DocIterator::hvdc_connected1.c_str())
        .def_readonly("connected2", &HvdcLineInfo::connected_2, DocIterator::hvdc_connected2.c_str())
        .def_readonly("bus1_id", &HvdcLineInfo::bus_1_id, DocIterator::hvdc_bus1_id.c_str())
        .def_readonly("bus2_id", &HvdcLineInfo::bus_2_id, DocIterator::hvdc_bus2_id.c_str())
        ...
        .def_readonly("voltage_level1_id", &HvdcLineInfo::sub_1_id, DocIterator::hvdc_sub1_id.c_str())
        .def_readonly("voltage_level2_id", &HvdcLineInfo::sub_2_id, DocIterator::hvdc_sub2_id.c_str());
