...
void bind_containers(py::module_& m) {
    ...
    py::class_<TrafoInfo>(m, "TrafoInfo", DocIterator::TrafoInfo.c_str())
        ...
        .def_readonly("limit_a1_ka", &TrafoInfo::limit_a1_ka, "Thermal (current) limit, hv side, in kA (NaN if not set, see `LSGrid.set_trafo_thermal_limit`).")
        .def_readonly("limit_a2_ka", &TrafoInfo::limit_a2_ka, "Thermal (current) limit, lv side, in kA (NaN if not set, see `LSGrid.set_trafo_thermal_limit`).")
    ...
    py::class_<LineInfo>(m, "LineInfo", DocIterator::LineInfo.c_str())
        ...
        .def_readonly("limit_a1_ka", &LineInfo::limit_a1_ka, "Thermal (current) limit, origin side, in kA (NaN if not set, see `LSGrid.set_line_thermal_limit`).")
        .def_readonly("limit_a2_ka", &LineInfo::limit_a2_ka, "Thermal (current) limit, extremity side, in kA (NaN if not set, see `LSGrid.set_line_thermal_limit`).")
