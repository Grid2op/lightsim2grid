...
between 0 and `n_sub_ * max_nb_bus_per_sub_`
    ...
    gridmodel_cls
        ...
        // solver control
        .def("change_algorithm", py::overload_cast<const AlgorithmType&>(&GridModel::change_algorithm), DocGridModel::change_algorithm.c_str())
        .def("change_algorithm", py::overload_cast<const std::string&>(&GridModel::change_algorithm), "Change the AC (or DC) algorithm by registry name. Accepts built-in names and plugin names registered via load_solver_plugin().")
        .def("available_default_algorithms", &GridModel::available_default_algorithms, DocGridModel::available_algorithm_names.c_str())
        .def("available_algorithm_names", &GridModel::available_algorithm_names, "Returns names of all registered algorithms, including any loaded plugins.")
        ...
        .def("get_dc_algo_type", &GridModel::get_dc_algo_type, DocGridModel::get_dc_algo_type.c_str())
        .def("get_algo", &GridModel::get_algo, py::return_value_policy::reference, DocGridModel::get_algo.c_str())
        .def("get_dc_algo", &GridModel::get_dc_algo, py::return_value_policy::reference, DocGridModel::get_dc_algo.c_str())
        // deprecated method
        .def("change_solver", py::overload_cast<const AlgorithmType&>(&GridModel::change_algorithm), "DEPRECATED: use 'change_algorithm' instead")
        .def("change_solver", py::overload_cast<const std::string&>(&GridModel::change_algorithm), "DEPRECATED: use 'change_algorithm' instead")
        .def("available_solvers", &GridModel::available_default_algorithms, "DEPRECATED: use 'available_default_algorithms' instead")
        .def("available_solver_names", &GridModel::available_algorithm_names, "DEPRECATED: use 'available_algorithm_names' instead")
        .def("get_solver_type", &GridModel::get_algo_type, "DEPRECATED: use 'get_algo_type' instead")
        .def("get_dc_solver_type", &GridModel::get_dc_algo_type, "DEPRECATED: use 'get_dc_algo_type' instead")
        .def("get_solver", &GridModel::get_algo, py::return_value_policy::reference, "DEPRECATED: use 'get_algo' instead")
        .def("get_dc_solver", &GridModel::get_dc_algo, py::return_value_policy::reference, "DEPRECATED: use 'get_dc_algo' instead")
        ...
        .def("get_algo_controler", &GridModel::get_algo_controler, "TODO", py::return_value_policy::reference)
        .def("get_solver_control",  &GridModel::get_algo_controler, "DEPRECATED use 'get_algo_controler'", py::return_value_policy::reference)
